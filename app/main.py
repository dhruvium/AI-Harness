...
from . import config
from .adapters import build_request, stream_upstream
from .models import Provider, ProviderIn, ChatRequest, Conversation, UploadOut
...
async def chat(req: ChatRequest):
    ...
    async def gen():
        url, headers, payload = build_request(provider, req.system, expanded, req.effort)
